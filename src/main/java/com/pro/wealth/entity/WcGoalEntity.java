...
@Table(name = "WCGOAL")
@Entity
public class WcGoalEntity implements WcGoal {
...
//
//    @OneToMany(mappedBy = "wcGoal", fetch = FetchType.LAZY)
//    private Set<WcInvestment> investments = new HashSet<>();
